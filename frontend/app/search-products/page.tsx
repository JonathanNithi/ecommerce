...
import { SEARCH_PRODUCTS, ProductSortField, SortDirection } from "@/graphql/queries/product-queries";
...
export default function SearchPage() {
  ...
  const { refetch: refetchProducts } = useQuery(SEARCH_PRODUCTS, {
    client, // Use the client created by your function
    variables: {
      field: sortField,
      direction: sortDirection,
        ...
        <div className="container py-24">
          <div className="mb-8">
            ...
            <p className="mt-2 text-muted-foreground">
              Here is a list of products based on your search criteria. 
            </p>
          </div>
